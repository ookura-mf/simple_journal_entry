...
public class AccountsRecord extends UpdatableRecordImpl<AccountsRecord> implements Record4<Long, String, String, Integer> {
    ...
    @Override
    public AccountsRecord values(Long value1, String value2, String value3, Integer value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccountsRecord(Long id, String code, String name, Integer elementType) {
        super(Accounts.ACCOUNTS);
